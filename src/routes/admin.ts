...
adminRoutes.post('/api/reports/campaigns/google-ads-sync', (c) => adminController.syncGoogleAdsCampaigns(c));
adminRoutes.get('/api/reports/campaigns/google-ads-sync-state', (c) => adminController.getGoogleAdsSyncState(c));
adminRoutes.put('/api/reports/campaigns/google-ads-sync-state', (c) => adminController.saveGoogleAdsSyncPrefs(c));
